...
- **Remote pattern:** `patterncatalyst/enterprise-integration-patterns-with-camel`
- **GitHub repo:** `patterncatalyst/enterprise-integration-patterns-with-camel`
- **Issue tracker:** GitHub
- **Issue tracker URL:** `https://github.com/patterncatalyst/enterprise-integration-patterns-with-camel/issues`
